...
class VoteApplicationProfileController extends BaseController {
  ...
  public static function get(): :xhp {
    ...
    $voteCandidate =
      VoteCandidate::loadByRoleAndUser($vote_role_id, $user_id);
    ...
    $gravatar_url =
      'https://secure.gravatar.com/avatar/'.$email_hash.'?s=200';
        ...
        <div class="col-md-8 col-md-offset-2">
          <div class="panel panel-default">
            <div class="panel-heading">
              <h1>
                {$user->getFullName()} for
                {VoteRole::getRoleName($vote_role_id)}
              </h1>
            </div>
